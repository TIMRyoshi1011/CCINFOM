...
- This Program is Made, Compiled and Run in Visual Studio Code <br> <br>
**To Compile**: javac -cp lib/mysql-connector-j-9.5.0.jar src/*.java -d out <br>
**To Run**: java -cp "lib/mysql-connector-j-9.5.0.jar;out" Main
